...
export default function OurTeam() {
  ...
  return (
    <section
      id="our-team"
      className="brand-px brand-py dotted-bg-light flex flex-col items-center justify-center gap-y-10"
    >
      {/* Title */}
      ...
      <div className="brand-max-w flex flex-col items-center justify-center gap-y-20">
        {/* Founder */}
        <div className="grid w-full grid-cols-1 items-center justify-center gap-5 text-center lg:grid-cols-2 lg:justify-between lg:gap-10 lg:text-left">
          <div className="relative mx-auto h-[450px] w-full max-w-[450px] overflow-hidden rounded-md bg-dark shadow-lg lg:h-[570px] xl:mx-0 xl:h-[520px]">
            <Image
              fill
              alt="founder"
              src={"/founder.png"}
        ...
        {/* Team */}
        <div className="gap-10 text-center lg:text-left">
          <Tagline>Our Team</Tagline>
          <Title isSub>Dedicated Experts Driving Telecom Innovation</Title>
          <div className="relative mx-auto mt-3 h-56 w-full overflow-hidden rounded-md lg:h-72 xl:h-96">
        ...
        <div className="w-full text-center">
          ...
          <Title style="max-w-xs md:max-w-none mx-auto" isSub>
            Our team is profiencent with thses MNO&apos;s
          </Title>
          <span className="mt-2 block h-[1px] w-full bg-primary opacity-25" />
          <div className="grid grid-cols-2 items-center justify-center bg-yellow-300">
